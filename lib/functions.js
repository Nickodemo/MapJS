...
*/
	...
	function resetHighlight(e) {
		layer_frutal_2014.resetStyle(e.target);
		layer_forestal_2014.resetStyle(e.target);
		layer_forzados_2014.resetStyle(e.target);
		layer_huerta_2014.resetStyle(e.target);
		layer_agua_2014.resetStyle(e.target);
		layer_pastizal_2014.resetStyle(e.target);
		layer_salinas_2014.resetStyle(e.target);
		
		layer_frutal_1987.resetStyle(e.target);
		layer_forestal_1987.resetStyle(e.target);
		layer_forzados_1987.resetStyle(e.target);
		layer_huerta_1987.resetStyle(e.target);
		layer_agua_1987.resetStyle(e.target);
		layer_pastizal_1987.resetStyle(e.target);
		layer_salinas_1987.resetStyle(e.target);
	}
	...
	function onEachFeature(feature, layer) {
		...
		if (feature.properties && feature.properties.Usos_suelo) {
			_str2 = "<p><h4>" + feature.properties.Usos_suelo + "</h4>" + turf.area(feature).toPrecision(6) + " m2</p>";
