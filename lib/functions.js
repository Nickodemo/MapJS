...
*/
	...
	function PopupArea(feature, layer) {
		...
		if (feature.properties && feature.properties.MUNICIPIO) {
			...
			_str2 = "<div class='row'><div class='col-md-4'><img class='img-circle' src='res/berja-38395379.jpg' alt='berja' height='105' width='105' style='margin-left: -5px;'></div><div class='col-md-8'><b><font size='4'>"+ feature.properties.MUNICIPIO + "</font></b>    " + _area.toFixed(2) + " km2<br><div style='font-size: 12px;'>El municipio... Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam nec porta ante. Donec vehicula luctus lorem. Nullam ac luctus nisl.</div></div></div>";
