...
*/
	...
	function geoprocesos1987(e){
		...
		if (type === 'marker') {
			...
			//Se crea pop up
			$("#info_modal").click();
			$("#info_prov").html('La superficie del circulo seleccionado es: '+(turf.area(polyCircle)/1000000).toFixed(2)+' km<sup>2</sup>');
			...
			$("#info_modal").click();
			$("#info_prov").html('La distancia de la línea es '+dist_polyline+' km<sup>2</sup>');
			//Se crea popup
		}
