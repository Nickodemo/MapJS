...
*/
	...
	function geoprocesos1987(e){
		...
		if (type === 'marker') {
			...
			char_data = [(area[0]/1000000).toFixed(3),(area[1]/1000000).toFixed(3),area[2]/1000000,area[3]/1000000,area[4]/1000000,area[5]/1000000,area[6]/1000000,area[7]/1000000];
			$("#info_modal").click();
			...
			//Se crea pop up
			char_data = [area[0]/1000000,area[1]/1000000,area[2]/1000000,area[3]/1000000,area[4]/1000000,area[5]/1000000,area[6]/1000000,area[7]/1000000];
			$("#info_modal").click();
			$("#info_prov").text('La superficie de las areas es '+ area[0]+'m2, '+ area[1]+'m2, '+ area[2]+'m2, '+ area[3]+'m2, '+ area[4]+'m2, '+ area[5]+'m2, '+ area[6]+'m2, '+ area[7]+'m2');
