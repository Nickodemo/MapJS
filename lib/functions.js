...
*/
	...
	function PopupArea(feature, layer) {
		...
		if (feature.properties && feature.properties.MUNICIPIO) {
			...
			_str2 = "<div class='row'><div class='col-md-4'><img class='img-circle' src='res/"+info_municipios[feature.properties.MUNICIPIO].image_name+"' alt='berja' height='105' width='105' style='margin-left: -5px;'></div><div class='col-md-8'><b><font size='4'>"+ info_municipios[feature.properties.MUNICIPIO].name + "</font></b>    " + _area.toFixed(2) + " km2<br><div style='font-size: 12px;'>"+info_municipios[feature.properties.MUNICIPIO].descrip+"</div></div></div>";
